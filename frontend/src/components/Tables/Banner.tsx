...
const Banner = () => {
  return (
    <section className="bg-slate-400 dark:bg-gray-900">
      <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
            Shop from a wide range of categories, enjoy great discounts, and
            experience seamless online shopping. Built with utility classes from{" "}
          ...
          {/* <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
            ...
            <a
              href="https://figma.com/file/your-figma-file"
              target="_blank"
