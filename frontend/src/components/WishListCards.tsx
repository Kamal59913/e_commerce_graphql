...
const WishListCards: React.FC<CategoryCardsProps> = ({
  title,
  image,
  description,
  price,
  ...
  return (
<div>
  <div className="border-2 border-slate-300 lg:w-[300px] dark:text-white" onClick={onProductCLick}>
    <img
      src={image}
      alt="Laptop"
    ...
    <div className="p-4">
      ...
      <button
        type="button"
        className="mt-4 w-full rounded-sm bg-black text-white dark:bg-slate-400 px-2 py-1.5 text-sm font-semibold shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
      >
        Add to Cart
      </button>
    </div>
